...
public class YelpAPI {
	...
	private static final String CLIENT_ID = "UY-d22I_xJKzNeVh_hfHWQ";
	private static final String CLIENT_SECRET = "hv5Dx3YDecSkYGVSaHpFQsg7zsFHbCv8LF3dG8J4JW9YURuuOr2hSeeOW10JtoB9";
	private static final String GRANT_TYPE = "client_credentials";
	private static final String TOKEN_TYPE = "Bearer";

	// Cache your access token so you get faster access to our data by eliminating
	// an extra request
	// for each API call.
