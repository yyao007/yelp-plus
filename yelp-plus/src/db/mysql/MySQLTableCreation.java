	...
	public static void main(String[] args) {
		try {
			...
			sql = "CREATE TABLE history " + "(history_id bigint(20) unsigned NOT NULL AUTO_INCREMENT, "
					...
					+ " last_favor_time timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP, "
					+ " PRIMARY KEY (history_id)," + " UNIQUE KEY `user_item_id` (`user_id`,`item_id`), "
